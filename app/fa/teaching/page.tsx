...
export const metadata: Metadata = {
  ...
  description:
    "نقش دکتر معماری به‌عنوان عضو هیئت علمی دانشگاه علوم پزشکی تهران، راهنمایی دانشجویان تحصیلات تکمیلی و دستیاران فلوشیپ بالینی، و فعالیت در برنامه‌های سلامت عمومی.",
