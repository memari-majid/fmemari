...
export const metadata: Metadata = {
  ...
  description:
    "وب‌سایت رسمی دکتر فریدون معماری، دانشیار جراحی دانشگاه علوم پزشکی تهران و متخصص جراحی سرطان در انستیتو کانسر، مجتمع بیمارستانی امام خمینی. با سابقه‌ی حرفه‌ای جراحی از سال ۱۳۷۱ در حوزه‌ی سرطان‌های پستان، گوارش و تیروئید، همراه با پژوهش ترجمانی در زیست‌شناسی سرطان، RNAهای غیرکدکننده، ایمنی‌درمانی و سلامت دیجیتال برای بازماندگان سرطان.",
  alternates: {
    canonical: "/fa",
    languages: {
      en: "/",
  ...
  openGraph: {
    ...
    description:
      "دانشیار جراحی دانشگاه علوم پزشکی تهران و متخصص جراحی سرطان در انستیتو کانسر، مجتمع بیمارستانی امام خمینی. با سابقه‌ی حرفه‌ای جراحی از سال ۱۳۷۱ همراه با پژوهش ترجمانی در سرطان.",
    url: `${SITE_URL}/fa`,
  ...
  twitter: {
    ...
    description:
      "متخصص جراحی سرطان با سابقه‌ی حرفه‌ای از سال ۱۳۷۱. جراحی سرطان، بازسازی انکوپلاستیک و پژوهش ترجمانی در دانشگاه علوم پزشکی تهران.",
