 ...
 * stays legible on the dark green-tinted pill background.
 */
const CANCER_RIBBON_COLORS: readonly string[] = [
  "text-pink-500 dark:text-pink-300", // breast cancer (pink is the international convention)
    ...
    <>
      ...
      >
        <div className="pointer-events-none absolute inset-0">
          ...
          <MolecularBonds className="absolute start-6 top-24 hidden h-20 w-20 text-green-600/30 dark:text-green-400/25 sm:block sm:h-28 sm:w-28" />
          <MolecularBonds className="absolute end-6 bottom-32 hidden h-24 w-24 -rotate-12 text-emerald-600/25 dark:text-emerald-400/20 sm:block sm:h-32 sm:w-32" />
        </div>
        ...
        <div className="relative z-10 mx-auto min-w-0 max-w-4xl px-4 text-center sm:px-6">
          ...
          <Reveal delay={400}>
            <div className="mx-auto mt-10 max-w-3xl rounded-2xl border border-green-200/70 bg-white/80 p-5 text-start shadow-sm backdrop-blur dark:border-green-900/40 dark:bg-zinc-900/60 sm:mt-14 sm:p-6">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div className="min-w-0">
                  <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-green-700 dark:text-green-400">
                ...
                <div className="flex shrink-0 flex-col gap-2 sm:items-end sm:text-end">
                  <a
                    ...
                    dir="ltr"
                    className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-green-600 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-green-500 sm:w-auto sm:py-2.5"
                  >
                    <svg
                      className="h-4 w-4"
                      viewBox="0 0 24 24"
          ...
          <div className="mt-12 grid gap-12 md:grid-cols-5 md:items-start">
            <Reveal delay={80} className="md:col-span-2">
              <div className="relative mx-auto w-fit md:mx-0">
                <DnaHelixBackground className="pointer-events-none absolute -inset-6 -z-10 h-[calc(100%+3rem)] w-[calc(100%+3rem)] text-green-500/15 dark:text-green-400/10" />

                <div
                  className="pointer-events-none absolute -inset-3 -z-10 rounded-3xl bg-gradient-to-br from-green-500/25 via-emerald-500/15 to-transparent blur-2xl"
                  aria-hidden
                />

                <div className="relative h-80 w-64 overflow-hidden rounded-2xl shadow-xl shadow-green-900/10 ring-1 ring-zinc-200 dark:shadow-green-950/40 dark:ring-zinc-700 sm:h-96 sm:w-72">
                  <Image
                ...
                <div className="absolute -bottom-3 -end-3 flex items-center gap-1.5 rounded-full border border-green-200 bg-white px-3 py-1.5 text-xs font-semibold text-green-700 shadow-lg dark:border-green-900/50 dark:bg-zinc-900 dark:text-green-400">
                  <svg
                    className="h-4 w-4"
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <div className="mt-8 space-y-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-start gap-3 rounded-xl border border-zinc-200/80 bg-white p-3 transition hover:border-green-400 dark:border-zinc-800/60 dark:bg-zinc-900/40 dark:hover:border-green-600"
                >
                  <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-green-100 text-green-700 dark:bg-green-950/50 dark:text-green-400">
                  ...
                  <span className="min-w-0">
                    ...
                    <span className="block text-sm font-semibold text-zinc-900 group-hover:text-green-700 dark:text-zinc-100 dark:group-hover:text-green-400">
                      {t.hero.affiliation}
                    </span>
                  ...
                  {renderAffiliationLine(t.about.bio.affiliationLine, {
                    tums: (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-green-700 underline decoration-green-700/30 hover:decoration-green-700 dark:text-green-400"
                      >
                        {t.hero.affiliationParent}
                      </a>
                    ),
                    cancerInstitute: (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-semibold text-zinc-900 underline decoration-zinc-300 hover:decoration-green-600 dark:text-zinc-100 dark:decoration-zinc-600 dark:hover:decoration-green-400"
                      >
      ...
      >
        <div className="mx-auto max-w-6xl">
                  ...
                  <div className="card flex h-full flex-col p-6">
                    ...
                    <ul className="mt-4 flex flex-wrap gap-1.5">
                      {card.bullets.map((b, j) => (
                        <li
                          key={b}
                          className="inline-flex items-center gap-1.5 rounded-full border border-green-200/80 bg-green-50/60 px-2.5 py-0.5 text-[11px] font-medium text-green-800 dark:border-green-900/50 dark:bg-green-950/40 dark:text-green-300"
                        >
                          {isCancerCard ? (
          ...
          <Reveal delay={200}>
            <div className="mt-12 rounded-2xl border border-green-200/80 bg-green-50/60 px-5 py-6 dark:border-green-900/40 dark:bg-green-950/20 sm:px-8">
              ...
              return (
                <Reveal key={card.key} delay={i * 50}>
                  ...
                  >
                    <span
                      aria-hidden
                      className="absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-green-400 via-emerald-400 to-sky-400 opacity-70"
                    />
                    <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">
                      {card.title}
                    </h3>
                    ...
                    <p className="mt-4 text-sm font-medium text-green-700 group-hover:text-green-800 dark:text-green-400 dark:group-hover:text-green-300">
      ...
      <section
        id="breast-cancer"
        className="relative scroll-mt-20 overflow-hidden border-t border-zinc-200/80 bg-gradient-to-b from-green-50/40 via-white to-white px-4 py-16 sm:py-24 lg:py-32 dark:border-zinc-800/40 dark:from-green-950/10 dark:via-zinc-950 dark:to-zinc-950 sm:px-6"
      >
        {/* Pink-tinted awareness accents in the corners — signals breast
            cancer without overwhelming the copy. */}
        <div
          aria-hidden
          className="pointer-events-none absolute start-6 top-16 hidden text-green-500/25 dark:text-green-300/20 sm:block"
        >
          <AwarenessRibbon className="h-20 w-14" />
        </div>
        <div
          aria-hidden
          className="pointer-events-none absolute end-6 bottom-20 hidden -rotate-12 text-green-400/25 dark:text-green-300/15 sm:block"
        >
            ...
            {t.breastCancer.stats.map((s, i) => (
              <Reveal key={s.label} delay={i * 60}>
                <div className="card flex h-full flex-col gap-1 p-5">
                  <p className="text-3xl font-semibold tracking-tight text-green-600 dark:text-green-300">
                    {s.value}
                  </p>
            ...
            {t.breastCancer.procedures.map((p, i) => (
              <Reveal key={p.name} delay={i * 60}>
                <article className="card relative flex h-full flex-col overflow-hidden p-6">
                  <span
                    aria-hidden
                    className="absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-green-400 via-green-300 to-emerald-300 opacity-70"
                  />
                  ...
                  <p className="mt-4 rounded-lg bg-green-50/70 px-3 py-2 text-xs leading-relaxed text-green-900/80 dark:bg-green-950/30 dark:text-green-200/80">
          ...
          <div className="mt-20 grid gap-6 lg:grid-cols-2">
                ...
                <ul className="mt-4 flex-1 space-y-2.5 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
                  {t.breastCancer.signs.map((s) => (
                    <li key={s} className="flex items-start gap-2.5">
                      <span
                        aria-hidden
                        className="mt-1.5 inline-block h-1.5 w-1.5 shrink-0 rounded-full bg-green-500 dark:bg-green-300"
                      />
                      <span>{s}</span>
                    </li>
                  ))}
            ...
            <Reveal delay={80}>
              <div className="card flex h-full flex-col p-6">
                ...
                <a
                  href={routes.contact}
                  className="mt-6 inline-flex w-max items-center gap-1 rounded-full bg-green-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-green-700"
                >
                  {t.breastCancer.cta}
                  <span aria-hidden>→</span>
                </a>
      ...
      >
        ...
        <CellClusterBackground className="pointer-events-none absolute inset-0 -z-0 h-full w-full text-green-600/10 dark:text-green-400/[0.06]" />
        <div className="relative mx-auto max-w-6xl">
          <Reveal>
            <p className="text-center text-xs font-medium uppercase tracking-[0.2em] text-zinc-500 dark:text-zinc-400">
              {t.research.eyebrow}
      ...
      >
        {/* Subtle helix motif — ties the news strip visually to the research
            ...
            readable. */}
        <DnaHelixBackground className="pointer-events-none absolute -top-10 end-0 -z-0 hidden h-80 w-80 rotate-12 text-green-500/10 dark:text-green-400/[0.08] sm:block" />
        <div className="relative mx-auto max-w-6xl">
          <Reveal>
            <div className="flex items-center justify-center gap-2">
              <span
                aria-hidden
                className="inline-flex h-2 w-2 rounded-full bg-green-500 shadow-[0_0_0_4px_rgba(16,185,129,0.15)] motion-safe:animate-pulse"
              />
              <p className="text-center text-xs font-medium uppercase tracking-[0.2em] text-zinc-500 dark:text-zinc-400">
                {t.news.eyebrow}
              </p>
              ...
              <Reveal key={item.title} delay={i * 60}>
                <article className="card group relative flex h-full flex-col overflow-hidden p-6">
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <span className="inline-flex items-center gap-1.5 rounded-full border border-green-200/80 bg-green-50/70 px-2.5 py-0.5 text-[11px] font-medium text-green-800 dark:border-green-900/50 dark:bg-green-950/40 dark:text-green-300">
                      <span className="text-green-500 dark:text-green-300">
            ...
            <Reveal delay={140}>
              <div className="mt-12 text-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-full border border-zinc-300 bg-white px-6 py-3 text-sm font-medium text-zinc-800 transition hover:border-green-500 hover:text-green-700 dark:border-zinc-700 dark:bg-zinc-900/60 dark:text-zinc-200 dark:hover:border-green-500"
                >
          ...
          <div className="mt-20 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <Reveal delay={80}>
              ...
              >
                ...
                <p
                  className="text-base font-semibold text-zinc-900 transition-colors group-hover:text-green-700 dark:text-zinc-100 dark:group-hover:text-green-400"
                  dir="ltr"
                >
                  {SITE.emailDisplay}
                </p>
            ...
            <Reveal delay={120}>
              ...
              >
                ...
                <p className="text-base font-semibold text-zinc-900 transition-colors group-hover:text-green-700 dark:text-zinc-100 dark:group-hover:text-green-400">
                  {t.hero.affiliation}
                </p>
                <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-500">
                  {t.hero.affiliationDetail}
            ...
            <Reveal delay={160}>
              <div className="card flex flex-col gap-2 p-6">
                ...
                <div className="mt-1 flex flex-col gap-1.5 text-xs text-zinc-600 dark:text-zinc-400">
                  <div className="flex items-baseline gap-2">
                    ...
                    <a
                      href={`tel:${CLINIC.phone}`}
                      dir="ltr"
                      className="font-medium text-zinc-800 transition-colors hover:text-green-700 dark:text-zinc-200 dark:hover:text-green-400"
                    >
                      {locale === "fa"
                        ? localizeDigits(CLINIC.phoneDisplayFa, locale)
                        : CLINIC.phoneDisplay}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-2 inline-flex w-max items-center gap-1 text-xs font-medium text-green-700 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300"
                >
                  {t.contact.cards.clinicMapsLabel}
                  <span aria-hidden>→</span>
                </a>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
            <div className="max-w-sm space-y-3">
              <div className="flex items-center gap-2.5">
                <span
                  aria-hidden
                  className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-gradient-to-br from-green-500 to-emerald-600 text-[11px] font-bold text-white"
                >
                  FM
                </span>
                ...
                <div className="mt-3 flex flex-col gap-2">
                  {profileLinks.map((l) => (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-xs text-zinc-600 transition hover:text-green-700 dark:text-zinc-400 dark:hover:text-green-400"
                    >
                      {l.label} →
                    </a>
                  ))}
