  ...
  explore: {
    ...
    cards: [
      ...
      },
      {
        ...
        body: "چهار محور پژوهشی همراه با فهرست مقالات داور-پسند، قابل جست‌وجو بر اساس موضوع.",
      ...
      },
      {
        ...
        body: "تدریس در دانشگاه علوم پزشکی تهران، راهنمایی دانشجویان و فلوها، پرسش‌های متداول، و فعالیت در حوزه‌ی سلامت عمومی.",
        cta: "اطلاعات بیشتر",
      },
      {
        key: "contact",
